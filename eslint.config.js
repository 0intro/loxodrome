...
export default ts.config(
	{
		ignores: [
			...
			'notam-viewer-net/.wrangler/',
			// Agent worktrees: whole checkouts of the tree, each linted in its
			// own; read from here, one of them fails `npm run verify` with
			// every error counted once per copy.
			'.claude/worktrees/',
		],
	},
