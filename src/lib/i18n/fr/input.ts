...
export const input = {
	...
	periodNotCoveredFrom: (p: { from: string }) =>
		`Ce briefing ne couvre qu’à partir de ${p.from}.`,
	periodNotCoveredFromTip:
		'Un briefing de route ne peut s’ouvrir qu’au moment où il est demandé, alors que la période consultée commence avant. Les NOTAM déjà expirés à cet instant n’ont jamais été récupérés. Réglez la période pour qu’elle commence à cet instant ou après afin de la briefer entièrement.',
	periodNotCoveredTip:
