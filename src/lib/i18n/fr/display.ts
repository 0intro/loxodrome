...
export const display = {
	...
	supaipLangTip:
		'Langue de l’objet des SUP AIP affiché dans le panneau de détail et les vignettes NOTAM (quand une version anglaise existe). Auto suit la langue de l’application. Le PDF est toujours proposé dans les deux langues.',
	title: 'Réglages',
