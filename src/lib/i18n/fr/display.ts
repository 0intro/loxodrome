...
export const display = {
	...
	hideAirportNotamMarkersTip:
		'Activé\u202f: masque le marqueur bleu ligne Q (de repli) d’un NOTAM d’aérodrome dont la position est sur l’aérodrome, là où se trouvent déjà le symbole et son anneau de repérage. Un NOTAM situé ailleurs conserve son marqueur, panne de radionavigation ou SIV fermé publié sous l’aérodrome. Les marqueurs de position rouges, les cercles et les zones ne sont jamais concernés. Ne s’applique que là où le symbole de l’aérodrome est dessiné\u202f: son type et son éditeur affichés dans Couches, et la carte assez zoomée pour lui.',
	langAuto: 'Auto',
	liveWeather: 'Météo en direct (METAR et TAF)',
	liveWeatherTip:
		'Récupère les METAR et TAF courants (NOAA Aviation Weather Center) pour la section Météo du panneau aérodrome, et toutes les autres sources météo en direct que propose cette application. Désactivé, aucune récupération météo n’a lieu, et le choix est mémorisé entre les sessions.',
	...
	profileAllAirspacesTip:
		'Désactivé\u202f: ne trace que les espaces actuellement affichés sur la carte (Couches)',
	...
	/* Réglages > Interface (téléphones)\u202f: la place de la commande des
	   couches, la barre d’outils en vol, le plein écran. */
	sectionInterface: 'Interface',
	layersControl: 'Commande des couches',
	layersControlToolbar: 'Barre d’outils',
	layersControlMap: 'Sur la carte',
	toolbarInFlight: 'Barre d’outils en vol',
	toolbarKept: 'Conservée',
	toolbarFolded: 'Repliée',
	flightFullscreen: 'Plein écran pendant l’enregistrement',
	flightFullscreenTip:
		'Masque la barre du navigateur, ou les barres système dans l’application, le temps d’un enregistrement. Un glissement depuis le bord de l’écran les fait réapparaître.',
