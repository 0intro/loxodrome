...
export const search = {
	...
	nearestHint: 'Les aérodromes à moins de 40 NM de l’aéronef, du plus proche au plus lointain, avec la fréquence à appeler et la piste la plus longue.',
	nearestNoPose: 'Pas encore de position\u202f: démarrez un vol, ou relisez une trace, pour lister les aérodromes autour de l’aéronef.',
	nearestNone: 'Aucun aérodrome à moins de 40 NM.',
