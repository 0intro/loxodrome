...
export const about = {
	...
	terrainData:
		'altitude du sol, ainsi que le sol le plus haut et le plus bas autour de chaque point, échantillonnés sur des tuiles d’altitude (l’indication sous le curseur, le profil du sol de la route, les altitudes minimales de sécurité, la hauteur au-dessus du sol pour les alertes d’espace aérien et le dossier imprimé)',
	egm96Data:
