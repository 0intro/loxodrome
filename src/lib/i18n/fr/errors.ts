...
export const errors = {
	...
	needAerodrome:
		'Saisissez au moins un code OACI d’aérodrome, par exemple LFPL LFPK LFFZ LFQB.',
	...
	sofiaPeriodPast: 'SOFIA-Briefing ne traite que la période à venir, et celle-ci est déjà passée.',
