...
export const route = {
	...
	loadTip: 'Charger des routes depuis un fichier YAML',
	...
	minAltTip:
		'Demi-largeur (NM de part et d’autre de la route) du couloir relief et obstacles servant au calcul de l’altitude minimale de sécurité de chaque segment',
	moveDown: 'Descendre',
	moveUp: 'Monter',
