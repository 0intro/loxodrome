...
export const search = {
	...
	nearestHint: 'Aerodromes within 40 NM of the aircraft, nearest first, with the frequency to call and the longest runway.',
	nearestNoPose: 'No position yet: start a flight, or replay a trace, to list the aerodromes around the aircraft.',
	nearestNone: 'No aerodrome within 40 NM.',
