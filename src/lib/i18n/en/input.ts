...
export const input = {
	...
	periodNotCoveredFrom: (p: { from: string }) => `This briefing only covers from ${p.from}.`,
	periodNotCoveredFromTip:
		'A route briefing can only open at the moment it was fetched, and the period you are viewing starts before that. NOTAMs that had already lapsed by this instant were never fetched. Set the period to start at or after it to brief the whole of it.',
	periodNotCoveredTip:
