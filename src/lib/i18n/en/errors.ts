...
export const errors = {
	...
	needAerodrome: 'Type at least one ICAO aerodrome ident, for example LFPL LFPK LFFZ LFQB.',
	...
	/** The pre-flight guard for a period SOFIA cannot brief at all: it briefs
	 *  from the present on, so a period wholly in the past could only be
	 *  answered with the coming 24 h (docs/sofia-briefing.md). */
	sofiaPeriodPast: 'SOFIA-Briefing only briefs from now on, and this period has already passed.',
