 ...
 * chart packs use, off the shared CHART_WORKER base (`<worker>/<id>/archive`:
 * GET streams, HEAD gives size and ETag, a single Range resumes), so a
 * document pack is a new object id on a route that already works rather than
 * any new plumbing.
 *
...
export const DOC_PACKS: readonly DocPackDef[] = [
	{ id: 'fr-vac', set: 'vac', slot: 'current', lang: null, archive: `${CHART_WORKER}/fr-vac/archive` },
	{
		id: 'fr-vac-next',
		set: 'vac',
		slot: 'next',
		lang: null,
		archive: `${CHART_WORKER}/fr-vac-next/archive`,
	},
	{ id: 'fr-sup-fr', set: 'sup', slot: null, lang: 'fr', archive: `${CHART_WORKER}/fr-sup-fr/archive` },
	{ id: 'fr-sup-en', set: 'sup', slot: null, lang: 'en', archive: `${CHART_WORKER}/fr-sup-en/archive` },
] as const;
