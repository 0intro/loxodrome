...
/** What a briefing was fetched FOR. 'aerodromes' is a list of ICAO idents,
 *  which is the only one of the three an app with no map viewport and no
 *  route workspace can ask for. */
export type AutorouterFetchKind = 'viewport' | 'route' | 'aerodromes';
