 ...
 * (the nav log's A4 pages and its kneeboard, the flight dossier, the weather
 * briefing, the NOTAM bulletin) mark themselves instead, since their
 * box-hiding and page setup are already their own.
 *
