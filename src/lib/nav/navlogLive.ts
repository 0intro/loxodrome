 ...
 *  joins just short of, where a plain no-stamp zone dropped both. A zone
 *  top beyond the route's total never promotes: that is the archetype's
 *  own end, and its held stamp dies at the climb-out's re-seed. */
