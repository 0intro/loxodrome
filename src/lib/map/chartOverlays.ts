...
export const CHART_LAYERS: ChartLayerDef[] = [
	{
		...
		sources: {
			public:
				...
				`${WORKER}/fr500/tiles/{z}/{x}/{y}.webp`,
			local: `${LOCAL}/fr500/tiles/{z}/{x}/{y}.png`,
		},
		archive: `${WORKER}/fr500/archive`,
		maxNativeZoom: 12,
	...
	},
	{
		...
		sources: {
			public:
				...
				`${WORKER}/fr250/tiles/{z}/{x}/{y}.webp`,
			local: `${LOCAL}/fr250/tiles/{z}/{x}/{y}.png`,
		},
		archive: `${WORKER}/fr250/archive`,
		maxNativeZoom: 13,
	...
	},
	{
		...
		sources: {
			public: `${WORKER}/dk500/tiles/{z}/{x}/{y}.webp`,
			local: `${LOCAL}/dk500/tiles/{z}/{x}/{y}.png`,
		},
		archive: `${WORKER}/dk500/archive`,
		maxNativeZoom: 12,
	...
	},
	{
		...
		sources: {
			...
			public: `${WORKER}/dk250/tiles/{z}/{x}/{y}.webp`,
			local: `${LOCAL}/dk250/tiles/{z}/{x}/{y}.png`,
		},
		archive: `${WORKER}/dk250/archive`,
		maxNativeZoom: 13,
	...
	},
	{
		...
		license: '© EANS',
		sources: {
			public: `${WORKER}/ee500/tiles/{z}/{x}/{y}.webp`,
			local: `${LOCAL}/ee500/tiles/{z}/{x}/{y}.png`,
		},
		archive: `${WORKER}/ee500/archive`,
		maxNativeZoom: 12,
	...
	},
	{
		...
		license: '© Isavia ANS',
		sources: {
			public: `${WORKER}/is500/tiles/{z}/{x}/{y}.webp`,
			local: `${LOCAL}/is500/tiles/{z}/{x}/{y}.png`,
		},
		archive: `${WORKER}/is500/archive`,
		maxNativeZoom: 12,
	...
	},
	{
		...
		license: '© ENAIRE',
		sources: {
			public: `${WORKER}/es500/tiles/{z}/{x}/{y}.webp`,
			local: `${LOCAL}/es500/tiles/{z}/{x}/{y}.png`,
		},
		archive: `${WORKER}/es500/archive`,
		maxNativeZoom: 12,
	...
	},
	{
		...
		sources: {
			public: `${WORKER}/us1000/tiles/{z}/{x}/{y}.webp`,
			local: `${LOCAL}/us1000/tiles/{z}/{x}/{y}.png`,
		},
		archive: `${WORKER}/us1000/archive`,
		maxNativeZoom: 11,
	...
	},
	{
		...
		license: 'Public domain',
		sources: {
			public: `${WORKER}/us500/tiles/{z}/{x}/{y}.webp`,
			local: `${LOCAL}/us500/tiles/{z}/{x}/{y}.png`,
		},
		archive: `${WORKER}/us500/archive`,
		maxNativeZoom: 12,
	...
	},
	{
		...
		license: 'Public domain',
		sources: {
			public: `${WORKER}/us250/tiles/{z}/{x}/{y}.webp`,
			local: `${LOCAL}/us250/tiles/{z}/{x}/{y}.png`,
		},
		archive: `${WORKER}/us250/archive`,
		maxNativeZoom: 13,
	...
	},
	{
		...
		license: 'Public domain',
		sources: {
			public: `${WORKER}/us125/tiles/{z}/{x}/{y}.webp`,
			local: `${LOCAL}/us125/tiles/{z}/{x}/{y}.png`,
		},
		archive: `${WORKER}/us125/archive`,
		maxNativeZoom: 14,
