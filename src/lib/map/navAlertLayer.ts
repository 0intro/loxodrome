...
/** The alert inks as fixed hex; Leaflet paths need a concrete colour, the
 *  --supaip precedent. They are the day --danger and --workbook-orange as
 *  they stood before theme.css darkened those for TEXT contrast on their
 *  tints, a test a stroke over the map does not take. */
const DANGER = '#d40000';
