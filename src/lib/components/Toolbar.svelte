<script lang="ts">
	 ...
	 * CLAUDE.md reserves that cluster for the flight tools, and this is a
	 * desk task. One record, two renditions (the desktop overflow row and
	...
	/* No Layers row: the toolbar's own button opens the same page, and the
	   chrome is the launchers' ONE home (CLAUDE.md). A second door to one
