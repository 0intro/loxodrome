<script lang="ts">
	...
	import { ui, selectAirport, revealMap } from '$lib/state/ui.svelte';
	...
	function onSelect(a: Airport): void {
		...
		// On a phone the page steps aside so the map, and the aerodrome's
		// sheet opening in the pane, are in view.
		revealMap();
	}
