...
<div class="tab-panel">
	...
	{#if ui.isMobile}
		<!-- Settings > Interface, phones only (docs/mobile-ui-review.md): the
		     three choices the pilot took on the mock. Each persists through
		     its setter, stored only away from its default. -->
		<fieldset class="group">
