...
export interface VacPanel {
	 ...
	 *
	 *  The AIXM form is DDMMSS.ss and 58 of the 82 pads the placed panels
	 *  stand on are published on a WHOLE ARCSECOND, which at 47 north is
	 *  30.9 m of latitude and 21.1 of longitude: about 10.8 m rms, on a pad
	 *  twenty to twenty-five metres across. It is the floor under the panel
	 *  and no reader can go below it, so the dataset states it rather than
	 *  leaving it to be rediscovered. Absent on every other kind of panel. */
	padGridM?: number;
