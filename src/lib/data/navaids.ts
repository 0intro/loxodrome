...
/** KANS Kosovo en-route navaids, from the eAIP's ENR 4.1 table. */
export const XK_NAVAIDS_URL = '/data/xk-navaids.json';
export const XK_NAVAIDS_NEXT_URL = '/data/xk-navaids.next.json';
