...
export async function fetchRouteNotamsFromSofia(): Promise<void> {
	...
	// The period the pilot is looking at, read ONCE so every route is briefed
	// for the same window: the flight's own start in Flight mode, the typed
	// start in Custom, else now.
