...
// The SIA also QUOTES the value it is stating, the way it quotes a callsign:
// "READ '120.455MHZ' (INSTEAD OF '120.450MHZ')" (C1108/26 LFLY). The quotes
// are absorbed here rather than in each tail, because they land on both ends
// of both values and every pattern below is built out of this one.
