...
const DOC_DESCRIPTION =
	'How Loxodrome handles data: no account, no tracking, no advertising; what stays on the device and what leaves it.';
...
code {
	...
	font-size: 0.9em;
	/* notam-proxy.alcyon.workers.dev does not fit a 360px phone unbroken. */
