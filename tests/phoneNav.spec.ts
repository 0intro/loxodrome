...
describe('pageOf', () => {
	it('maps every desktop tab onto a page, the content tabs onto a section', () => {
		...
		// Named like every other: without one the page comes up on whichever
		// section was last used, and Alerts or Replay hides the trace group
		// that an arriving GPX is the receipt for.
		expect(pageOf('navigation')).toEqual({ page: 'flight', section: 'flight' });
