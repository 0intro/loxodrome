...
aggregator whose data may be redistributed here.
...
- **Attribution.** The About dialog's Italy card names "open flightmaps"
  ...
  "open flightmaps OFMX (community)"; the README's source table names
  it too. Every surface also says the data is community-maintained rather
  than published by ENAV, so a pilot is never led to believe they are
  reading the Italian AIP.
