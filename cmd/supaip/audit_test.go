...
func TestAuditCorpus(t *testing.T) {
	...
	// Create the report directory rather than failing a half-hour sweep on
	// its absence, which is what cmd/vacgeo's audit does and what anyone
	// naming a fresh directory expects.
	...
	//   210/2026  the night-VFR itinerary north of Paris: a POINTS DE
	//             REPORT table creating SNL, MERU and naming BSN,
	//             NANTEUIL and MAGNY, after the PON VOR is withdrawn at
	//             AIRAC 10/26. Points on a route, not a zone; the same
	//             shape as 009/2026
	...
	wantNoGeom := map[string]bool{
		...
		"metropole-2026-193": true, "metropole-2026-210": true,
		"pac-n-2026-001": true,
	}
